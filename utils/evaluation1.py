...
# Material values (midgame) — simple but widely used.
PIECE_VALUES = {
    chess.PAWN: 100,
    chess.KNIGHT: 320,
    chess.BISHOP: 330,
...
# Piece-square tables (bonus per square index) — white's POV.
# These are adapted from Sunfish / Simplified Stockfish.
# Values reversed for black automatically.
PAWN_TABLE = [
     0,  0,  0,  0,  0,  0,  0,  0,
